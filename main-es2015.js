...
let ItemContentComponent = class ItemContentComponent {
    constructor() {
...
let ProcessingJsonComponent = class ProcessingJsonComponent {
    constructor(uploadService, router) {
...
ProcessingJsonComponent.ctorParameters = () => [
...
let UploadJsonComponent = class UploadJsonComponent {
...
UploadJsonComponent.ctorParameters = () => [
...
let TextCopyDirective = class TextCopyDirective {
    constructor(notify) {
        this.notify = notify;
    }
    copyText() {
...
TextCopyDirective.ctorParameters = () => [
...
let GetTypePipe = class GetTypePipe {
    transform(elem) {
        if (elem === null) {
            return 'any';
        }
...
let GetUnitPipe = class GetUnitPipe {
    transform(unitType, item) {
        if (unitType === 'array') {
...
let BtnUploadComponent = class BtnUploadComponent {
...
BtnUploadComponent.ctorParameters = () => [
    { type: _core_upload_service__WEBPACK_IMPORTED_MODULE_2__["UploadService"] }
];
